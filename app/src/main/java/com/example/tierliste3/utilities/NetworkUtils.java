package com.example.tierliste3.utilities;
...
public class NetworkUtils {
     ...
     */
    public static ArrayList<Film> fetchData(String url) throws IOException {
    ...
    public static void parseJson(String data, ArrayList<Film> list){
        ...
        try {
            ...
            for (int i = 0; i < resArray.length(); i++) {
                ...
                Film movie = new Film(); //New Movie object
